  ...
  el.innerHTML = `
    ...
    <div style="padding:24px 24px 40px;display:flex;flex-direction:column;align-items:center;gap:20px;">
      ...
      <div style="width:100%;max-width:320px;border-radius:20px;overflow:hidden;box-shadow:0 8px 24px rgba(26,18,10,0.12);">
        <div style="background:#27864A;padding:20px 22px;display:flex;align-items:center;gap:16px;">
          <div style="width:52px;height:52px;border-radius:26px;background:rgba(255,255,255,0.18);display:flex;align-items:center;justify-content:center;">
            <i class="ph ph-fork-knife" style="font-size:26px;color:#fff;"></i>
          </div>
          <div>
            <div style="font-family:var(--font-mono);font-size:10px;letter-spacing:2.5px;color:rgba(255,255,255,0.75);">WANDERKIND</div>
            <div style="font-size:17px;font-weight:900;color:#fff;margin-top:2px;">FOOD PASS</div>
          </div>
        </div>
        <div style="background:var(--surface);padding:20px 22px;display:flex;align-items:center;gap:16px;">
          ...
          <div>
            ...
            <div style="font-family:var(--font-mono);font-size:11px;color:#27864A;letter-spacing:1.5px;margin-top:4px;">${wkId}</div>
          </div>
        </div>
        <div style="background:#27864A12;padding:14px 22px;border-top:1px solid #27864A22;">
          <div style="font-size:12px;color:var(--ink2);line-height:1.6;">Shared meals, community kitchens, road-food networks</div>
        </div>
      </div>
      <div class="wk-card" style="width:100%;max-width:320px;">
        <div class="h-label" style="margin-bottom:8px;">HOW TO USE</div>
        <p style="font-size:13px;color:var(--ink2);line-height:1.7;margin:0;">Access to meals shared on the road. Show this pass when accepting food from hosts or community kitchens.</p>
      </div>
    </div>
  `;
